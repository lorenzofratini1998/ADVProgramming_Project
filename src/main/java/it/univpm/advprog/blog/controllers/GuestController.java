...
public class GuestController {
    ...
    public String showPostByArchive(@PathVariable("archive_name") String archiveName, Model uiModel) {
    	...
    	List<Post> allPostsByArchive = this.postService.getByArchive(selectedArchive);
    ...
    public String showPostByTag(@PathVariable("tag_name") String tagName, Model uiModel) {
    	...
    	List<Post> allPostsByTag = this.postService.getByTag(selectedTag);
    ...
    public String showPostByAuthor(@PathVariable("username") String userName, Model uiModel) {
    	...
    	List<Post> allPostsByAuthor = this.userService.findPosts(userName);
    ...
    public String showPostDetails(@PathVariable("post_id") String post_id, Model uiModel) {
    	...
    	List<Comment> allCommentsOfPost = this.commentService.getCommentsFromPost(selectedPost);
    	List<Tag> allTagOfPost = this.tagService.getTagsFromPost(selectedPost);
    	List<Attachment> attachmentOfPost = this.attachmentService.getByPost(selectedPost);
    	List<Archive> archiveOfPost = this.archiveService.getArchivesFromPost(selectedPost);
    	List<User> authorOfPost = this.userService.getUserFromPost(selectedPost);
    	...
    	uiModel.addAttribute("commentsPost", allCommentsOfPost);
    	uiModel.addAttribute("tagsPost", allTagOfPost);
    	uiModel.addAttribute("attachmentsPost", attachmentOfPost);
    	uiModel.addAttribute("archivesPost", archiveOfPost);
    	uiModel.addAttribute("usersPost", authorOfPost);
    	uiModel.addAttribute("shortdescription", shortDescriptionOfPost);
    	uiModel.addAttribute("longdescription", longDescriptionOfPost );
